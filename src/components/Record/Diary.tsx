...
export const Diary = ({ initialItems }: DiaryProps) => {
  ...
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
        {items.map((item) => (
          <div key={item.id} className="border-2 border-[#707070] p-4 pb-[27px] flex flex-col gap-2 bg-white">
            ...
            <div className="flex-1 min-h-[80px] lg:min-h-[132px]">
